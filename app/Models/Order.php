...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'shipping_total',
        'shipping_cashback',
        'shipping_actual_value',
        'shipping_discrepancy_note',
        'shipping_reconciled_at',
        'shipping_retry_fee',
        'shipping_retry_count',
        'cod_service_fee',
        'unique_code',
        'used_unique_code',
        'grand_total',
    ...
    protected function casts(): array
    {
        return [
            ...
            'shipping_actual_value' => 'integer',
            'shipping_reconciled_at' => 'datetime',
            'shipping_retry_fee' => 'integer',
            'shipping_retry_count' => 'integer',
            'cod_service_fee' => 'integer',
            'unique_code' => 'integer',
